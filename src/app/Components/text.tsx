{/* <main>
      ...
      <div className='absolute top-[-150px] md:top-[-90px] flex flex-col justify-start items-center bg-[#000000] mx-4 h-[293px] w-[358px] rounded-[16px] gap-16 md:flex-row md:h-[180px] md:w-[1240px] md:self-center '>
        ...
        <input type="text" placeholder='Enter your email address' className='h-[45px] w-[280px] text-[16px]' />
        </div>
